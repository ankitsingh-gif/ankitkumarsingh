...
export default function Contact() {
  return (
    <section id="contact" className="py-24 md:py-32 px-6 md:px-10 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-mint/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <a href={`mailto:${siteConfig.email}`}
            className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-accent text-white font-semibold rounded-2xl hover:shadow-lg hover:shadow-accent/25 hover:-translate-y-0.5 transition-all duration-300">
            <MailIcon />
            {siteConfig.email}
          </a>
          <a href={`tel:${siteConfig.phone}`}
            className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-fg font-semibold rounded-2xl border border-border hover:border-accent hover:text-accent hover:-translate-y-0.5 transition-all duration-300 shadow-sm">
            <PhoneIcon />
            {siteConfig.phone}
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            <a key={l.name} href={l.href} target="_blank" rel="noopener noreferrer"
              className="w-12 h-12 flex items-center justify-center bg-bg-card rounded-xl border border-border text-fg-secondary hover:text-accent hover:border-accent hover:-translate-y-1 transition-all duration-300"
              aria-label={l.name}
            >
              {l.icon}
            </a>
