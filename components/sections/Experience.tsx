      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {experience.map((entry, i) => (
            <motion.div
              key={i}
              className="bg-bg rounded-2xl p-6 md:p-8 border border-border card-hover group"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8 mb-4">
                {/* Company icon */}
                <div className="w-12 h-12 rounded-xl bg-accent-bg flex items-center justify-center shrink-0">
                  <span className="text-accent text-lg font-display font-bold">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      {entry.active && (
                        <span className="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-semibold rounded-full tracking-wider">
                          CURRENT
                        </span>
                      )}
                  ...
                  <p className="text-accent text-sm font-medium mb-4">{entry.company}</p>
